                    ...
                    courses.forEach((course, idx) => {
                        if (course.textContent.trim() === id) {
                            ...
                            if (!dupeNotification.innerHTML) {
                                dupeNotification.innerHTML = `<button id="dupeLink"><i class='dupe-alert fa-solid fa-circle-exclamation' title='This course already appears in your pathway.' aria-label='This course already appears in your pathway.' role='img'></i><span>Duplicate Courses Found in Pathway</span></button>`;
                            }
                        }
                    });
                }
